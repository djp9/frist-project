    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category"
                                                             value="Indian_Fruits" />Indian_Fruits</label>
            <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category"
                                                             value="Imported_Fruits" />Imported_Fruits</label>
            <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category"
                                                             value="Fruit_Products" />Fruit_Products</label>
        </div>
        ...
        <div class="form-group">
            ...
            <label class="checkbox-inline"><form:radiobutton path="productCondition" id="condition"
                                                             value="Fresh" />Organic</label>
            <label class="checkbox-inline"><form:radiobutton path="productCondition" id="condition"
                                                             value="Inorganic" />Inorganic</label>
        </div>
        ...
        <div class="form-group">
            <label for="manufacturer">Packed By</label>
